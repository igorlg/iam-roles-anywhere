...
And `~/.aws/iam-ra/admin.sh` (managed declaratively by home-manager - it's a
...
Tradeoff: one extra file per profile under `~/.aws/iam-ra/` in exchange for a
